...
public class addMonhoc extends AppCompatActivity implements AdapterView.OnItemSelectedListener {
    ...
    private Button btnNgaythi;

    private EditText edtNgaythi;
    ...
    public void init() {
        ...
        btnNgaythi = (Button) findViewById(R.id.btnNgaythi);
        edtNgaythi = (EditText) findViewById(R.id.edtNgaythi);
        btnNgaythi.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                ...
                DatePickerDialog datePickerDialog = new DatePickerDialog(addMonhoc.this, new DatePickerDialog.OnDateSetListener() {
                    @Override
                    public void onDateSet(DatePicker view, int year, int monthOfYear, int dayOfMonth) {
                        ...
                        edtNgaythi.setText(year+"-"+month+"-"+day );
                    }
                }, year, month, day);
    ...
    public void addMonhoc(View view) {
        ...
        values.put("ngaythi", edtNgaythi.getText().toString());
    ...
    public void loadListStudent() {
        ...
        while (c.isAfterLast() == false) {
            list.add("mã môn: " + c.getString(0) + " -tên môn: " + c.getString(1)
                    + " - lớp: " + c.getString(2) +"- ngày thi:"+c.getString(3));
            c.moveToNext();
        }
        c.close();
        adapter.notifyDataSetChanged();
